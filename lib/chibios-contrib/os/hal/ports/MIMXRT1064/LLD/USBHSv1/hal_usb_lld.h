 ...
 * @brief   MIMXRT1064 USB subsystem low level driver header.
 *
 * @addtogroup USB
 * @{
 */
 ...
 */
#if !defined(MIMXRT1064_USB_USE_USB1) || defined(__DOXYGEN__)
#define MIMXRT1064_USB_USE_USB1                  TRUE
#endif

#if !defined(MIMXRT1064_USB1_IS_USBOTG)
#define MIMXRT1064_USB1_IS_USBOTG TRUE
#endif

/**
 * @brief   USB1 interrupt priority level setting.
 */
#if !defined(MIMXRT1064_USB_USB1_IRQ_PRIORITY)|| defined(__DOXYGEN__)
#define MIMXRT1064_USB_USB1_IRQ_PRIORITY      3
#endif

#if !defined(MIMXRT1064_USB_ENDPOINTS) || defined(__DOXYGEN__)
#define MIMXRT1064_USB_ENDPOINTS (USB_MAX_ENDPOINTS+1)
#endif
...
#if MIMXRT1064_USB_USE_USB1 && !MIMXRT1064_HAS_USB
#error "USB not present in the selected device"
#endif

#if !MIMXRT1064_USB_USE_USB1
#error "USB driver activated but no USB peripheral assigned"
#endif

#if MIMXRT1064_USB_USE_USB1 &&                                                   \
    !OSAL_IRQ_IS_VALID_PRIORITY(MIMXRT1064_USB_USB1_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to MIMXRT1064_USB_USB1_IRQ_PRIORITY"
#endif

#if !defined(MIMXRT1064_USB_OTG1_IRQ_VECTOR)
#error "MIMXRT1064_USB_OTG1_IRQ_VECTOR not defined"
#endif
...
#if MIMXRT1064_USB_USE_USB1 && !defined(__DOXYGEN__)
